...
public class MemberAdapter extends RecyclerView.Adapter<MemberAdapter.ViewHolder> {
    ...
    //아답타 안에서 일어나는 특정 이벤트를 전달받을 객체 type 을 미리 정의하기
